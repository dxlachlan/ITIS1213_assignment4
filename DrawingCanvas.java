...
//            ArrayList<Line> lines = myModel.getShapes();
//            for (Line l : lines) {
//                l.draw(g2d);
//            }
//            
...
//            ArrayList<Rectangle> rects = myModel.getRects();
//            for (Rectangle r : rects) {
//                r.draw(g2d);
//            }
            
            
            //get the shapes ArrayList from the model, and
            //iterate through it, telling each Shape object to draw itself
